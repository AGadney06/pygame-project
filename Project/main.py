...
class Game:
    def __init__(self): #Constructor
        ...
        self.live_x_start_pos = screen_width - (self.live_surf.get_size()[0] * 2 + 20) # gets the width of the lives surface
        ...
        for row_index, row in enumerate(self.shape):
            for col_index,col in enumerate(row):
                if col == 'x':
                    ...
                    block = obstacle.Block(self.block_size,(0,255,0),x,y)
    ...
    def display_lives(self):
        for live in range (self.lives - 1): # -1 used to not display any visible lives once you're on your last life
